...
toggle.addEventListener('click', function() {
  ...
  if (this.classList.toggle('bi-moon')) {
    ...
    document.getElementById('box5').style.backgroundImage = "linear-gradient(to left top, #FCEABB, #F8B500)";
    document.getElementById('box6').style.backgroundImage = "linear-gradient(to left top, #FCEABB, #F8B500)";
    document.getElementById('box7').style.backgroundImage = "linear-gradient(to left top, #FCEABB, #F8B500)";
    document.getElementById('box8').style.backgroundImage = "linear-gradient(to left top, #FCEABB, #F8B500)";
    document.getElementById('box9').style.backgroundImage = "linear-gradient(to left top, #FCEABB, #F8B500)";
    document.getElementById('box10').style.backgroundImage = "linear-gradient(to left top, #FCEABB, #F8B500)";
    document.getElementById('box11').style.backgroundImage = "linear-gradient(to left top, #FCEABB, #F8B500)";
    document.getElementById('box12').style.backgroundImage = "linear-gradient(to left top, #FCEABB, #F8B500)";
    document.getElementById('box13').style.backgroundImage = "linear-gradient(to left top, #FCEABB, #F8B500)";
    document.getElementById('box14').style.backgroundImage = "linear-gradient(to left top, #FCEABB, #F8B500)";
    document.getElementById('box15').style.backgroundImage = "linear-gradient(to left top, #FCEABB, #F8B500)";
    document.getElementById('box16').style.backgroundImage = "linear-gradient(to left top, #FCEABB, #F8B500)";
